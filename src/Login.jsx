    ...
    return (
        <div className='font-rubik bg-[#F3F4F6]'>
          ...
          <nav
                    ...
                    >
                        ...
                        >
                            <li>
                                <a
                                    onClick={() => navigate('/')}
                                    className="block py-2 px-3 text-[#4e31aa] hover:text-[#4e31aa] bg-[#4e31aa] rounded md:bg-transparent   md:p-0"
                                    aria-current="page"
                                >
                                    Home
                                </a>
            ...
            <div className="font-rubik flex justify-center sm:min-h-screen" style={{  backgroundColor: '#f3f4f6', paddingTop: '2rem', marginTop: '4rem' }}>
